...
class IngredientController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $ingredients = $em->getRepository('FoodBundle:Ingredient')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('FoodBundle\Form\IngredientType', $ingredient);
    ...
    {
        $deleteForm = $this->createDeleteForm($ingredient);
        $editForm = $this->createForm('FoodBundle\Form\IngredientType', $ingredient);
